            ...
            <div class="card profile-tab">
                ...
                <div class="card-body custom-tab-1">
                    <ul class="nav nav-tabs mb-3">
                        <li class="nav-item"><a href="#about-me" data-toggle="tab" class="nav-link pb-2">Normal Users</a></li><li class="nav-item"><a href="#my-posts" data-toggle="tab" class="nav-link pb-2 active show">Scholar Users</a></li>
